...
class InventoryExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithEvents
{
    ...
    {
        return Inventory::where('property_id', $this->propertyId)->with('category');
    }
