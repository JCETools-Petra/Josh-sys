...
class FinancialReportService
{
    ...
    public function getComparativeAnalysis(int $propertyId, int $year, int $month): array
    {
        ...
        return [
            'current' => [
                ...
                'revenue' => $currentPnL['totals']['total_revenue']['actual_current'] ?? 0,
                'mice' => $currentMice,
                'expense' => $currentPnL['totals']['total_expenses']['actual_current'] ?? 0,
                'gop' => $currentPnL['totals']['gross_operating_profit']['actual_current'] ?? 0,
            ],
            'mom' => [
                'period' => $prevMonth->format('F Y'),
                'revenue' => $prevMonthPnL['totals']['total_revenue']['actual_current'] ?? 0,
                ...
                'expense' => $prevMonthPnL['totals']['total_expenses']['actual_current'] ?? 0,
                ...
                'gop' => $prevMonthPnL['totals']['gross_operating_profit']['actual_current'] ?? 0,
            ...
            'yoy' => [
                ...
                'revenue' => $lastYearPnL['totals']['total_revenue']['actual_current'] ?? 0,
                'revenue_change' => $this->calculatePercentageChange(
                ...
                'expense' => $lastYearPnL['totals']['total_expenses']['actual_current'] ?? 0,
                'expense_change' => $this->calculatePercentageChange(
                    $lastYearPnL['totals']['total_expenses']['actual_current'],
                    $currentPnL['totals']['total_expenses']['actual_current']
                ),
                'gop' => $lastYearPnL['totals']['gross_operating_profit']['actual_current'] ?? 0,
                'gop_change' => $this->calculatePercentageChange(
    ...
    private function accumulateTotals(array &$target, array $source): void
    {
        ...
        $target['forecast_current'] += $source['forecast_current'] ?? 0;
        $target['forecast_ytd'] += $source['forecast_ytd'] ?? 0;
    }
