...
class SettingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            // ✅ SECURITY FIX: Removed SVG from allowed types to prevent XSS
        ...
        // Clear all cache to ensure settings are updated everywhere
        \Artisan::call('cache:clear');
        \Artisan::call('view:clear');

        return redirect()->route('admin.settings.index')->with('success', 'Pengaturan berhasil diperbarui. Logo dan favicon telah diupdate.');
    }
