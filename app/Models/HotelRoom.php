...
class HotelRoom extends Model
{
    ...
    /**
     * Get the user who assigned this room.
     */
    ...
    public function markAsClean()
    {
        ...
        event(new RoomStatusChanged($this, $oldStatus, 'vacant_clean', auth()->id()));
    }
    ...
    public function markAsDirty()
    {
        ...
        // Dispatch event for automatic notifications
        event(new RoomStatusChanged($this, $oldStatus, 'vacant_dirty', auth()->id()));
    }
