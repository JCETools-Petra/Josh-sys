...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex space-x-3">
            ...
            <a href="{{ route('restaurant.sales-report') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg transition">
                Sales Report
            </a>
    ...
    <div id="content_history" class="tab-content hidden">
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-xl font-bold text-gray-800">Riwayat Order</h2>
                <a href="{{ route('restaurant.orders.history') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition">
                    Lihat Semua Riwayat
                </a>
            </div>
            ...
            <div class="text-center py-12 text-gray-500">
                ...
                <p class="text-lg mb-4">Lihat Riwayat Order Lengkap</p>
                <p class="text-sm text-gray-400 mb-4">Untuk melihat riwayat order dengan filter lengkap, klik tombol di atas</p>
                <a href="{{ route('restaurant.orders.history') }}" class="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition">
                    Lihat Riwayat Order
                </a>
            </div>
        </div>
