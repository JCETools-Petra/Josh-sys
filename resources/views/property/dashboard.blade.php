<x-property-user-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            {{-- 🔧 BUG FIX: Add Pending Check-In section for property users --}}
            @if($pendingCheckInToday->count() > 0)
            <div class="bg-indigo-50 border-l-4 border-indigo-500 rounded-lg shadow-lg dark:bg-indigo-900 dark:border-indigo-600">
                <div class="p-4">
                    <div class="flex items-start">
                        <svg class="w-8 h-8 text-indigo-600 dark:text-indigo-300 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                        </svg>
                        <div class="flex-1">
                            <h3 class="text-lg font-bold text-indigo-900 dark:text-indigo-200">Reservasi Perlu Check-In Hari Ini ({{ $pendingCheckInToday->count() }})</h3>
                            <p class="text-sm text-indigo-700 dark:text-indigo-300 mb-3">Reservasi yang dijadwalkan check-in hari ini dan perlu diproses</p>
                            <div class="space-y-2">
                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-lg p-3 border border-indigo-200 dark:border-indigo-700">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            <div class="font-semibold text-gray-900 dark:text-gray-100">{{ $reservation->guest->full_name }}</div>
