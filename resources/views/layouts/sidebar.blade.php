    ...
    <nav class="flex-1 overflow-y-auto p-4 space-y-2">
        @auth
            ...
            @if(in_array(Auth::user()->role, ['admin', 'owner']))
                ...
                <x-side-nav-link :href="route('admin.cash-drawer.index')" :active="request()->routeIs('admin.cash-drawer.*')">
                    <x-slot name="icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path></svg></x-slot>
                    {{ __('Cash Drawer') }}
                </x-side-nav-link>

                {{-- Bagian Inventaris --}}
                <p class="px-4 pt-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Inventaris</p>
                ...
                {{-- Bagian MICE --}}
                <p class="px-4 pt-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">MICE</p>
                ...
                {{-- Bagian Administrasi --}}
                <p class="px-4 pt-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Administrasi</p>
                ...
                <p class="px-4 pt-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Keuangan & Budgeting</p>
            ...
            @elseif(Auth::user()->role === 'inventaris')
                <p class="px-4 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Inventaris</p>
            ...
            @elseif(Auth::user()->role === 'hk')
                <x-side-nav-link :href="route('housekeeping.dashboard')" :active="request()->routeIs('housekeeping.dashboard')">
                    <x-slot name="icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg></x-slot>
                    {{ __('Dashboard Housekeeping') }}
                </x-side-nav-link>
                <x-side-nav-link :href="route('housekeeping.inventory.index')" :active="request()->routeIs('housekeeping.inventory.*')">
                    <x-slot name="icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg></x-slot>
                    {{ __('Inventaris Kamar') }}
                </x-side-nav-link>
                <x-side-nav-link :href="route('housekeeping.tasks.index')" :active="request()->routeIs('housekeeping.tasks.*')">
                    <x-slot name="icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path></svg></x-slot>
                    {{ __('Tasks') }}
                </x-side-nav-link>
                ...
                <x-side-nav-link :href="route('housekeeping.lost-found.index')" :active="request()->routeIs('housekeeping.lost-found.*')">
                    <x-slot name="icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg></x-slot>
                    {{ __('Lost & Found') }}
                </x-side-nav-link>
                <x-side-nav-link :href="route('housekeeping.performance')" :active="request()->routeIs('housekeeping.performance')">
                    <x-slot name="icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg></x-slot>
            ...
            @elseif(Auth::user()->role === 'pengguna_properti')
                ...
                <x-side-nav-link :href="route('frontoffice.index')" :active="request()->routeIs('frontoffice.index') || request()->routeIs('frontoffice.room-grid') || request()->routeIs('frontoffice.check-in') || request()->routeIs('frontoffice.checkout*') || request()->routeIs('frontoffice.folio*') || request()->routeIs('frontoffice.guest*') || request()->routeIs('frontoffice.extend-stay*') || request()->routeIs('frontoffice.change-room*') || request()->routeIs('frontoffice.group-checkin*') || request()->routeIs('frontoffice.no-show*')">
                ...
                <x-side-nav-link :href="route('frontoffice.cash-drawer.index')" :active="request()->routeIs('frontoffice.cash-drawer.*')">
                    <x-slot name="icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path></svg></x-slot>
                    {{ __('Cash Drawer') }}
                </x-side-nav-link>
                ...
                <x-side-nav-link :href="route('kitchen.display')" :active="request()->routeIs('kitchen.*')">
                    <x-slot name="icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg></x-slot>
                    {{ __('Kitchen Display') }}
                </x-side-nav-link>
                ...
                <x-side-nav-link :href="route('maintenance.index')" :active="request()->routeIs('maintenance.*')">
                    <x-slot name="icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path></svg></x-slot>
                    {{ __('Maintenance') }}
                </x-side-nav-link>
                <x-side-nav-link :href="route('refunds.index')" :active="request()->routeIs('refunds.*')">
                    <x-slot name="icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"></path></svg></x-slot>
                    {{ __('Refunds') }}
                </x-side-nav-link>
