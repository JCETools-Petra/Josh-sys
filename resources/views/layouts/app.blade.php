...
<head>
    ...
    {{-- Dark Mode: Prevent Flash of Unstyled Content (FOUC) --}}
    <script>
    ...
    @if(isset($appSettings['favicon_path']))
        <link rel="icon" type="image/png" href="{{ asset('storage/' . $appSettings['favicon_path']) }}?v={{ filemtime(public_path('storage/' . $appSettings['favicon_path'])) }}">
    @else
            ...
            <header class="flex justify-between items-center px-6 py-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <div class="flex items-center space-x-4 flex-1 min-w-0">
                    ...
                    <button
                        ...
                        class="p-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 lg:hidden transition-colors"
