    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <x-card>
                    <x-card.header>
                        <x-card.title>Distribusi Sumber Pendapatan</x-card.title>
                ...
                <x-card>
                    <x-card.header>
                        <x-card.title>Pendapatan per Properti</x-card.title>
                        <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <x-card>
                ...
                <x-card.body class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <x-table>
                            <x-table.head>
                                <tr>
                                    ...
                                    <x-table.header>Klien</x-table.header>
                            ...
                            <x-table.body>
                                @foreach($recentMiceBookings as $booking)
                                    <x-table.row>
                                        ...
                                        <x-table.cell>{{ $booking->client_name }}</x-table.cell>
                                        <x-table.cell nowrap>{{ $booking->property->name ?? '-' }}</x-table.cell>
                                        <x-table.cell nowrap>
