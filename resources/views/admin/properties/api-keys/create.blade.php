    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Buat API Key Baru - ') }}{{ $property->name }}
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.properties.api-keys.store', $property) }}">
                        @csrf
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                                        <p>API key akan ditampilkan hanya sekali setelah dibuat. Pastikan Anda menyimpannya dengan aman di tempat yang aman.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
