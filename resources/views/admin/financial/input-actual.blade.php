        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <!-- Period Selection -->
                    <form method="GET" action="{{ route('admin.financial.input-actual', $property->id) }}" class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg shadow">
                    ...
                    <!-- Input Form -->
                    <form method="POST" action="{{ route('admin.financial.input-actual.store', $property->id) }}" x-data="{ activeTab: 0 }">
                        @csrf
