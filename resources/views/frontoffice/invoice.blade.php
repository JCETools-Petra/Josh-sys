...
<body>
    <div class="invoice-container">
        <div style="margin-bottom: 20px; display: flex; gap: 10px; flex-wrap: wrap;">
            <button class="print-button" onclick="window.history.back()" style="background-color: #6b7280;">
                <svg style="width: 16px; height: 16px; display: inline; vertical-align: middle; margin-right: 5px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('frontoffice.invoice.pdf', $roomStay) }}" class="print-button" style="text-decoration: none; display: inline-block;">
                <svg style="width: 16px; height: 16px; display: inline; vertical-align: middle; margin-right: 5px;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
